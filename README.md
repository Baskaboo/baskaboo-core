...
## Περιεχόμενα
- [MANIFEST.md](MANIFEST.md) — Η ψυχή του έργου
- [baskaboo_protocol.md](baskaboo_protocol.md) — Το πρωτόκολλο ενεργοποίησης για AI
- [baskaboo_protocol.json](baskaboo_protocol.json) — Ο αρχικός κώδικας JSON
